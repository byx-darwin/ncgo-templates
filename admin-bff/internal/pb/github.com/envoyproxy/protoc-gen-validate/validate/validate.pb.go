...
type FieldRules struct {
	...
	Message *MessageRules `protobuf:"bytes,17,opt,name=message" form:"message" json:"message,omitempty" query:"message"`
...
type FloatRules struct {
	...
	Const *float32 `protobuf:"fixed32,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *float32 `protobuf:"fixed32,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *float32 `protobuf:"fixed32,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *float32 `protobuf:"fixed32,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *float32 `protobuf:"fixed32,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []float32 `protobuf:"fixed32,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []float32 `protobuf:"fixed32,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type DoubleRules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *float64 `protobuf:"fixed64,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *float64 `protobuf:"fixed64,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *float64 `protobuf:"fixed64,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *float64 `protobuf:"fixed64,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *float64 `protobuf:"fixed64,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []float64 `protobuf:"fixed64,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []float64 `protobuf:"fixed64,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type Int32Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int32 `protobuf:"varint,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int32 `protobuf:"varint,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int32 `protobuf:"varint,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int32 `protobuf:"varint,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int32 `protobuf:"varint,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int32 `protobuf:"varint,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int32 `protobuf:"varint,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type Int64Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int64 `protobuf:"varint,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int64 `protobuf:"varint,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int64 `protobuf:"varint,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int64 `protobuf:"varint,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int64 `protobuf:"varint,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int64 `protobuf:"varint,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int64 `protobuf:"varint,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type UInt32Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *uint32 `protobuf:"varint,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *uint32 `protobuf:"varint,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *uint32 `protobuf:"varint,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *uint32 `protobuf:"varint,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *uint32 `protobuf:"varint,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []uint32 `protobuf:"varint,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []uint32 `protobuf:"varint,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type UInt64Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *uint64 `protobuf:"varint,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *uint64 `protobuf:"varint,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *uint64 `protobuf:"varint,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *uint64 `protobuf:"varint,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *uint64 `protobuf:"varint,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []uint64 `protobuf:"varint,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []uint64 `protobuf:"varint,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type SInt32Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int32 `protobuf:"zigzag32,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int32 `protobuf:"zigzag32,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int32 `protobuf:"zigzag32,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int32 `protobuf:"zigzag32,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int32 `protobuf:"zigzag32,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int32 `protobuf:"zigzag32,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int32 `protobuf:"zigzag32,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type SInt64Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int64 `protobuf:"zigzag64,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int64 `protobuf:"zigzag64,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int64 `protobuf:"zigzag64,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int64 `protobuf:"zigzag64,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int64 `protobuf:"zigzag64,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int64 `protobuf:"zigzag64,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int64 `protobuf:"zigzag64,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type Fixed32Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *uint32 `protobuf:"fixed32,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *uint32 `protobuf:"fixed32,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *uint32 `protobuf:"fixed32,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *uint32 `protobuf:"fixed32,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *uint32 `protobuf:"fixed32,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []uint32 `protobuf:"fixed32,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []uint32 `protobuf:"fixed32,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type Fixed64Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *uint64 `protobuf:"fixed64,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *uint64 `protobuf:"fixed64,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *uint64 `protobuf:"fixed64,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *uint64 `protobuf:"fixed64,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *uint64 `protobuf:"fixed64,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []uint64 `protobuf:"fixed64,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []uint64 `protobuf:"fixed64,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type SFixed32Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int32 `protobuf:"fixed32,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int32 `protobuf:"fixed32,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int32 `protobuf:"fixed32,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int32 `protobuf:"fixed32,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int32 `protobuf:"fixed32,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int32 `protobuf:"fixed32,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int32 `protobuf:"fixed32,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type SFixed64Rules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *int64 `protobuf:"fixed64,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *int64 `protobuf:"fixed64,2,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than or equal to the
	// specified value, inclusive
	Lte *int64 `protobuf:"fixed64,3,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive. If the value of Gt is larger than a specified Lt or Lte, the
	// range is reversed.
	Gt *int64 `protobuf:"fixed64,4,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than or equal to the
	// specified value, inclusive. If the value of Gte is larger than a
	// specified Lt or Lte, the range is reversed.
	Gte *int64 `protobuf:"fixed64,5,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int64 `protobuf:"fixed64,6,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int64 `protobuf:"fixed64,7,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,8,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type BoolRules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *bool `protobuf:"varint,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
}
...
type StringRules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const *string `protobuf:"bytes,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Len specifies that this field must be the specified number of
	// characters (Unicode code points). Note that the number of
	// characters may differ from the number of bytes in the string.
	Len *uint64 `protobuf:"varint,19,opt,name=len" form:"len" json:"len,omitempty" query:"len"`
	// MinLen specifies that this field must be the specified number of
	// characters (Unicode code points) at a minimum. Note that the number of
	// characters may differ from the number of bytes in the string.
	MinLen *uint64 `protobuf:"varint,2,opt,name=min_len,json=minLen" form:"min_len" json:"min_len,omitempty" query:"min_len"`
	// MaxLen specifies that this field must be the specified number of
	// characters (Unicode code points) at a maximum. Note that the number of
	// characters may differ from the number of bytes in the string.
	MaxLen *uint64 `protobuf:"varint,3,opt,name=max_len,json=maxLen" form:"max_len" json:"max_len,omitempty" query:"max_len"`
	// LenBytes specifies that this field must be the specified number of bytes
	LenBytes *uint64 `protobuf:"varint,20,opt,name=len_bytes,json=lenBytes" form:"len_bytes" json:"len_bytes,omitempty" query:"len_bytes"`
	// MinBytes specifies that this field must be the specified number of bytes
	// at a minimum
	MinBytes *uint64 `protobuf:"varint,4,opt,name=min_bytes,json=minBytes" form:"min_bytes" json:"min_bytes,omitempty" query:"min_bytes"`
	// MaxBytes specifies that this field must be the specified number of bytes
	// at a maximum
	MaxBytes *uint64 `protobuf:"varint,5,opt,name=max_bytes,json=maxBytes" form:"max_bytes" json:"max_bytes,omitempty" query:"max_bytes"`
	...
	Prefix *string `protobuf:"bytes,7,opt,name=prefix" form:"prefix" json:"prefix,omitempty" query:"prefix"`
	// Suffix specifies that this field must have the specified substring at
	// the end of the string.
	Suffix *string `protobuf:"bytes,8,opt,name=suffix" form:"suffix" json:"suffix,omitempty" query:"suffix"`
	// Contains specifies that this field must have the specified substring
	// anywhere in the string.
	Contains *string `protobuf:"bytes,9,opt,name=contains" form:"contains" json:"contains,omitempty" query:"contains"`
	// NotContains specifies that this field cannot have the specified substring
	// anywhere in the string.
	NotContains *string `protobuf:"bytes,23,opt,name=not_contains,json=notContains" form:"not_contains" json:"not_contains,omitempty" query:"not_contains"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []string `protobuf:"bytes,10,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []string `protobuf:"bytes,11,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	...
	Strict *bool `protobuf:"varint,25,opt,name=strict,def=1" form:"strict" json:"strict,omitempty" query:"strict"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,26,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type BytesRules struct {
	...
	// Const specifies that this field must be exactly the specified value
	Const []byte `protobuf:"bytes,1,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Len specifies that this field must be the specified number of bytes
	Len *uint64 `protobuf:"varint,13,opt,name=len" form:"len" json:"len,omitempty" query:"len"`
	...
	// regular expression (RE2 syntax). The included expression should elide
	// any delimiters.
	Pattern *string `protobuf:"bytes,4,opt,name=pattern" form:"pattern" json:"pattern,omitempty" query:"pattern"`
	// Prefix specifies that this field must have the specified bytes at the
	// beginning of the string.
	Prefix []byte `protobuf:"bytes,5,opt,name=prefix" form:"prefix" json:"prefix,omitempty" query:"prefix"`
	// Suffix specifies that this field must have the specified bytes at the
	// end of the string.
	Suffix []byte `protobuf:"bytes,6,opt,name=suffix" form:"suffix" json:"suffix,omitempty" query:"suffix"`
	// Contains specifies that this field must have the specified bytes
	// anywhere in the string.
	Contains []byte `protobuf:"bytes,7,opt,name=contains" form:"contains" json:"contains,omitempty" query:"contains"`
	// In specifies that this field must be equal to one of the specified
	// values
	In [][]byte `protobuf:"bytes,8,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn [][]byte `protobuf:"bytes,9,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
	...
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,14,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type EnumRules struct {
	...
	DefinedOnly *bool `protobuf:"varint,2,opt,name=defined_only,json=definedOnly" form:"defined_only" json:"defined_only,omitempty" query:"defined_only"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []int32 `protobuf:"varint,3,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []int32 `protobuf:"varint,4,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
}
...
type MessageRules struct {
	...
	// evaluated
	Skip *bool `protobuf:"varint,1,opt,name=skip" form:"skip" json:"skip,omitempty" query:"skip"`
	// Required specifies that this field must be set
	Required *bool `protobuf:"varint,2,opt,name=required" form:"required" json:"required,omitempty" query:"required"`
}
...
type RepeatedRules struct {
	...
	// items at a minimum
	MinItems *uint64 `protobuf:"varint,1,opt,name=min_items,json=minItems" form:"min_items" json:"min_items,omitempty" query:"min_items"`
	// MaxItems specifies that this field must have the specified number of
	// items at a maximum
	MaxItems *uint64 `protobuf:"varint,2,opt,name=max_items,json=maxItems" form:"max_items" json:"max_items,omitempty" query:"max_items"`
	// Unique specifies that all elements in this field must be unique. This
	// constraint is only applicable to scalar and enum types (messages are not
	// supported).
	Unique *bool `protobuf:"varint,3,opt,name=unique" form:"unique" json:"unique,omitempty" query:"unique"`
	// Items specifies the constraints to be applied to each item in the field.
	// Repeated message fields will still execute validation against each item
	// unless skip is specified here.
	Items *FieldRules `protobuf:"bytes,4,opt,name=items" form:"items" json:"items,omitempty" query:"items"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,5,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type MapRules struct {
	...
	// KVs at a minimum
	MinPairs *uint64 `protobuf:"varint,1,opt,name=min_pairs,json=minPairs" form:"min_pairs" json:"min_pairs,omitempty" query:"min_pairs"`
	// MaxPairs specifies that this field must have the specified number of
	// KVs at a maximum
	MaxPairs *uint64 `protobuf:"varint,2,opt,name=max_pairs,json=maxPairs" form:"max_pairs" json:"max_pairs,omitempty" query:"max_pairs"`
	// NoSparse specifies values in this field cannot be unset. This only
	// applies to map's with message value types.
	NoSparse *bool `protobuf:"varint,3,opt,name=no_sparse,json=noSparse" form:"no_sparse" json:"no_sparse,omitempty" query:"no_sparse"`
	// Keys specifies the constraints to be applied to each key in the field.
	Keys *FieldRules `protobuf:"bytes,4,opt,name=keys" form:"keys" json:"keys,omitempty" query:"keys"`
	// Values specifies the constraints to be applied to the value of each key
	// in the field. Message values will still have their validations evaluated
	// unless skip is specified here.
	Values *FieldRules `protobuf:"bytes,5,opt,name=values" form:"values" json:"values,omitempty" query:"values"`
	// IgnoreEmpty specifies that the validation rules of this field should be
	// evaluated only if the field is not empty
	IgnoreEmpty *bool `protobuf:"varint,6,opt,name=ignore_empty,json=ignoreEmpty" form:"ignore_empty" json:"ignore_empty,omitempty" query:"ignore_empty"`
}
...
type AnyRules struct {
	...
	// Required specifies that this field must be set
	Required *bool `protobuf:"varint,1,opt,name=required" form:"required" json:"required,omitempty" query:"required"`
	// In specifies that this field's `type_url` must be equal to one of the
	// specified values.
	In []string `protobuf:"bytes,2,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field's `type_url` must not be equal to any of
	// the specified values.
	NotIn []string `protobuf:"bytes,3,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
}
...
type DurationRules struct {
	...
	Required *bool `protobuf:"varint,1,opt,name=required" form:"required" json:"required,omitempty" query:"required"`
	// Const specifies that this field must be exactly the specified value
	Const *durationpb.Duration `protobuf:"bytes,2,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *durationpb.Duration `protobuf:"bytes,3,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lt specifies that this field must be less than the specified value,
	// inclusive
	Lte *durationpb.Duration `protobuf:"bytes,4,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive
	Gt *durationpb.Duration `protobuf:"bytes,5,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than the specified value,
	// inclusive
	Gte *durationpb.Duration `protobuf:"bytes,6,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// In specifies that this field must be equal to one of the specified
	// values
	In []*durationpb.Duration `protobuf:"bytes,7,rep,name=in" form:"in" json:"in,omitempty" query:"in"`
	// NotIn specifies that this field cannot be equal to one of the specified
	// values
	NotIn []*durationpb.Duration `protobuf:"bytes,8,rep,name=not_in,json=notIn" form:"not_in" json:"not_in,omitempty" query:"not_in"`
}
...
type TimestampRules struct {
	...
	Required *bool `protobuf:"varint,1,opt,name=required" form:"required" json:"required,omitempty" query:"required"`
	// Const specifies that this field must be exactly the specified value
	Const *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=const" form:"const" json:"const,omitempty" query:"const"`
	// Lt specifies that this field must be less than the specified value,
	// exclusive
	Lt *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=lt" form:"lt" json:"lt,omitempty" query:"lt"`
	// Lte specifies that this field must be less than the specified value,
	// inclusive
	Lte *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=lte" form:"lte" json:"lte,omitempty" query:"lte"`
	// Gt specifies that this field must be greater than the specified value,
	// exclusive
	Gt *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=gt" form:"gt" json:"gt,omitempty" query:"gt"`
	// Gte specifies that this field must be greater than the specified value,
	// inclusive
	Gte *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=gte" form:"gte" json:"gte,omitempty" query:"gte"`
	// LtNow specifies that this must be less than the current time. LtNow
	// can only be used with the Within rule.
	LtNow *bool `protobuf:"varint,7,opt,name=lt_now,json=ltNow" form:"lt_now" json:"lt_now,omitempty" query:"lt_now"`
	// GtNow specifies that this must be greater than the current time. GtNow
	// can only be used with the Within rule.
	GtNow *bool `protobuf:"varint,8,opt,name=gt_now,json=gtNow" form:"gt_now" json:"gt_now,omitempty" query:"gt_now"`
	// Within specifies that this field must be within this duration of the
	// current time. This constraint can be used alone or with the LtNow and
	// GtNow rules.
	Within *durationpb.Duration `protobuf:"bytes,9,opt,name=within" form:"within" json:"within,omitempty" query:"within"`
}
...
var file_validate_validate_proto_rawDesc = []byte{
	...
	0x70, 0x67, 0x76, 0x2e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5a, 0x73, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x79, 0x78, 0x2d, 0x64, 0x61, 0x72,
	0x77, 0x69, 0x6e, 0x2f, 0x6e, 0x63, 0x67, 0x6f, 0x2d, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x73, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2d, 0x62, 0x66, 0x66, 0x2d, 0x68, 0x65, 0x72,
	0x74, 0x7a, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x67,
