...
[`../kitex/design-doc.en.md`](../kitex/design-doc.en.md).
...
- `../hertz/rate-limit-dynamic-design.en.md` — dedicated dynamic rate-limit design (includes `rule_center` source)
...
- `../kitex/design-doc.en.md` — Kitex counterpart
