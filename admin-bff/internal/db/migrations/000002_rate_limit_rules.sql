...
-- +goose Down
DROP INDEX IF EXISTS ux_rate_limit_rules_exact;
DROP INDEX IF EXISTS ux_rate_limit_rules_fallback;
DROP INDEX IF EXISTS ux_rate_limit_rules_pattern_app;
DROP INDEX IF EXISTS ux_rate_limit_rules_pattern_fallback;
